"""
Trains a Swin Transformer to predict length of stay from chest
radiographs, with stratified 5-fold cross-validation.
"""
import os
import numpy as np
import pandas as pd
...
# Load metadata
df = pd.read_csv('/path/to/data/patient_dict.csv')
